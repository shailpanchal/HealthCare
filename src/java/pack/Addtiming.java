 ...
 * @author Dell
 */
@WebServlet(name = "Addtiming", urlPatterns = {"/Addtiming"})
public class Addtiming extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String day=request.getParameter("t1");
       ...
       obj.modify("insert into timing(Day,Frm,T,Doctor_id) values('"+ day +"','"+ from +"','"+ to +"','"+ Docid +"')");
